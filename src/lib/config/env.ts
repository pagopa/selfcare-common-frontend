...
export const CONFIG = {
  ...
  FOOTER: {
    LINK: {
      ...
      PRIVACYPOLICY: showStaticPrivacyPolicy() ? (import.meta.env.VITE_URL_PRIVACY_POLICY_STATIC as string) || ''
        : appendBackstageParam((import.meta.env.VITE_URL_PRIVACY_DISCLAIMER as string) || ''),
