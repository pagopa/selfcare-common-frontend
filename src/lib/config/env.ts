...
export const CONFIG = {
  ...
  FOOTER: {
    LINK: {
      ...
      PRIVACYPOLICY: env.get('REACT_APP_URL_FILE_PRIVACY_DISCLAIMER').required().asString(),
      TERMSANDCONDITIONS: env.get('REACT_APP_URL_FILE_TERMS_AND_CONDITIONS').required().asString(),
