...
export { default as FooterOld } from './components/Footer/FooterOld';
...
export { default as useErrorDispatcher } from './hooks/useErrorDispatcher';
...
export { default as UserNotifyHandle } from './components/UserNotifyHandle';
export { default as useUserNotify } from './hooks/useUserNotify';
